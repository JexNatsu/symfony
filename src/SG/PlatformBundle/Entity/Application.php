 ...
 * @ORM\Entity(repositoryClass="SG\PlatformBundle\Repository\ApplicationRepository")
...
class Application
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="SG\PlatformBundle\Entity\Advert", inversedBy="applications")
